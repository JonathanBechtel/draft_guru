defmodule DraftGuruWeb.UsersAuth do
  use DraftGuruWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_draft_guru_web_users_remember_me"
  ...
  def log_out_users(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      DraftGuruWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_users:
      ...
      defmodule DraftGuruWeb.PageLive do
        use DraftGuruWeb, :live_view

        on_mount {DraftGuruWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{DraftGuruWeb.UsersAuth, :ensure_authenticated}] do
