defmodule DraftGuru.Accounts.Users do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, DraftGuru.Repo)
  ...
  """
  def valid_password?(%DraftGuru.Accounts.Users{hashed_password: hashed_password}, password)
